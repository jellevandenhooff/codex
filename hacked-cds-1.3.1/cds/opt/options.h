...
namespace opt {
    ...
    */
    ...
    /**
        ...
        Sometimes, this types of allocator should be different ones for performance reason.
    ...
    */
    ...
    /// Copy policy option
    /**
        The copy policy defines an item copying algorithm which is used when a container is resized.
