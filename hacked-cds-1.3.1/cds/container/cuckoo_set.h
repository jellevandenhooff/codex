...
#           endif
    ...
    */
    ...
    {
        //@cond
        typedef typename details::make_cuckoo_set<T, Traits>::type  base_class ;
        //@endcond
...
#       endif
        ...
        */
        ...
        {
#       ifdef CDS_CXX11_LAMBDA_SUPPORT
            return base_class::find_with( val, cmp, [&f](node_type& item, Q& val) { cds::unref(f)( item.m_val, val );}) ;
#       else
            find_wrapper<Func> wrapper(f)   ;
            return base_class::find_with( val, cmp, cds::ref(wrapper) ) ;
#       endif
        }
        ...
        */
        ...
        {
#       ifdef CDS_CXX11_LAMBDA_SUPPORT
            return base_class::find_with( val, cmp, [&f](node_type& item, Q const& val) { cds::unref(f)( item.m_val, val );}) ;
#       else
            find_wrapper<Func> wrapper(f) ;
            return base_class::find_with( val, cmp, cds::ref(wrapper) ) ;
#       endif
        ...
        /// Find the key \p val with comparing functor \p cmp
        /**
            The function is an analog of \ref find(Q const&) but \p cmp is used for key compare.
            \p Compare has the interface like \p std::less.
            \p cmp must imply the same element order as the comparator used for building the set.
        */
        ...
        {
#       ifdef CDS_CXX11_LAMBDA_SUPPORT
            return base_class::find_with( val, cmp, [](node_type&, Q const&) {}) ;
#       else
            return base_class::find_with( val, cmp, empty_find_functor()) ;
#       endif
        }
        ...
        */
        ...
        {
#       ifdef CDS_CXX11_LAMBDA_SUPPORT
            return base_class::find_equal( val, eq, [&f](node_type& item, Q& val) { cds::unref(f)( item.m_val, val );}) ;
#       else
            find_wrapper<Func> wrapper(f) ;
            return base_class::find_equal( val, eq, cds::ref(wrapper) ) ;
#       endif
        }
        ...
        */
        ...
        {
#       ifdef CDS_CXX11_LAMBDA_SUPPORT
            return base_class::find_equal( val, eq, [](node_type& , Q const& ) {} )    ;
#       else
            return base_class::find_equal( val, eq, empty_find_functor() )    ;
#       endif
        }
