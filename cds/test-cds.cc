...
Linearizability linearizability(6);
...
struct Configure {
  Configure() {
    ...
    linearizability.AddStep(0, []() { ds->enqueue(1234); return 0; }, "ds->enqueue(1234); return 0;");
    linearizability.AddStep(1, []() { ds->enqueue(1235); return 0; }, "ds->enqueue(1235); return 0;");
    linearizability.AddStep(2, []() { ds->enqueue(1236); return 0; }, "ds->enqueue(1236); return 0;");
    linearizability.AddStep(3, []() { int x; return ds->dequeue(&x) ? x : -1; }, "int x; return ds->dequeue(&x) ? x : -1;");
    linearizability.AddStep(4, []() { int x; return ds->dequeue(&x) ? x : -1; }, "int x; return ds->dequeue(&x) ? x : -1;");
    linearizability.AddStep(5, []() { int x; return ds->dequeue(&x) ? x : -1; }, "int x; return ds->dequeue(&x) ? x : -1;");
  }
};
